    ...
    <form class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="sfzd" type="radio" value="1" class="status" checked>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="remark" cols="" rows="" class="textarea"  placeholder="说点什么..."  dragonfly="true" onKeyUp="Huitextarealength(this,100)"></textarea>
    ...
    $("#form-member-add").validate({
        ...
        submitHandler:function(form){
            $('#form-member-add').ajaxSubmit({
                ...
                url: "<?php echo U('New/add_do');?>", // 需要提交的 url
                data: {
                },
