...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" id="serverurl" value=""
                       name="serverurl">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" id="appid" value=""
                       name="appid">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" id="appsecret" value=""
                       name="appsecret">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" id="token" value=""
                       name="token">
            </div>
        </div>
        <div class="row cl">
...
//            success: "valid",
            submitHandler: function (form) {
                $('#form-admin-add').ajaxSubmit({
                    ...
                    url: "<?php echo U('Hospital/add_do');?>", // 需要提交的 url
                    data: {
                    },
