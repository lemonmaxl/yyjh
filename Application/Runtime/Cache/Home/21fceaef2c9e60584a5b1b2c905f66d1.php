...
<article class="page-container">
    <form class="form form-horizontal" id="form-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" id="flag" value="<?php echo ($data["flag"]); ?>"
                       name="flag">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                <input type="hidden" class="hidden" name="id" value="<?php echo ($data["id"]); ?>" />
