...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" id="linkurl" value=""
                       name="linkurl">
            </div>
        </div>
        <div class="row cl">
			...
			<select class="select" id="pid" size="1">
                <option value="0">项级模块</option>
                <?php if(is_array($selectlist)): $i = 0; $__LIST__ = $selectlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">├<?php echo ($vo["delimiter"]); echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
			</span></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8 skin-minimal">
                <div class="radio-box">
                    <input name="mstaus" type="radio" value="0" class="mstaus" checked>
                    <label for="sex-1">启用</label>
                </div>
                <div class="radio-box">
                    <input name="mstaus" type="radio" value="1" class="mstaus">
...
//            success: "valid",
            submitHandler: function (form) {
                $('#form-admin-add').ajaxSubmit({
                    ...
                    url: "<?php echo U('SysModule/add_do');?>", // 需要提交的 url
                    data: {
                        'name': $('#name').val(),
                        'linkurl': $('#linkurl').val(),
                        'pid': $('#pid').val(),
