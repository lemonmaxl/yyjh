    ...
    <form class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <select class="select" id="ks" size="1" name="ks">
                    <?php if(is_array($kslist)): foreach($kslist as $key=>$vo): ?><option <?php if($vo['name'] == $data['ks']): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                </select>
                </span>
            </div>
        </div>  
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="sfzd" type="radio" value="1" class="sfzd" <?php if($data["sfzd"] == 1): ?>checked="checked"<?php endif; ?>>
                    <label for="sex-1">否</label>
                </div>
                <div class="radio-box">
                    <input name="sfzd" type="radio" value="2" class="sfzd" <?php if($data["sfzd"] == 2): ?>checked="checked"<?php endif; ?>>
    ...
    $("#form-member-add").validate({
        ...
        submitHandler:function(form){
            $('#form-member-add').ajaxSubmit({
                ...
                url: "<?php echo U('Docter/edit_do');?>", // 需要提交的 url
                data: {
                },
