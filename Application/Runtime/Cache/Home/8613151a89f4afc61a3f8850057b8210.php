...
<div class="page-container">
    <form class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="remark" cols="" rows="" class="textarea"  placeholder="说点什么..." dragonfly="true" onKeyUp="Huitextarealength(this,100)"><?php echo ($data["remark"]); ?></textarea>
            </div>
        </div>
...
$("#form-member-add").validate({
    ...
    submitHandler:function(form){
        $('#form-member-add').ajaxSubmit({
            ...
            url: "<?php echo U('New/edit_do');?>", // 需要提交的 url
            data: {
            },
