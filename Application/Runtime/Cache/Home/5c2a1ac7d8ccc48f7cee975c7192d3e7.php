    ...
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8 skin-minimal">
                <div class="radio-box">
                    <input name="sfsf" type="radio" value="0" class="mstaus" checked>
                    <label for="sex-1">收费</label>
                </div>
                <div class="radio-box">
                    <input name="sfsf" type="radio" value="1" class="mstaus" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8 skin-minimal">
                <div class="radio-box">
                    <input name="mstatus" type="radio" value="0" class="mstatus" checked>
                    <label for="sex-1">启用</label>
                </div>
                <div class="radio-box">
                    <input name="mstatus" type="radio" value="1" class="mstatus" >
...
//            success: "valid",
            submitHandler: function (form) {
                $('#form-admin-add').ajaxSubmit({
                    ...
                    url: "<?php echo U('Qylxset/add_do');?>", // 需要提交的 url
                    data: {
