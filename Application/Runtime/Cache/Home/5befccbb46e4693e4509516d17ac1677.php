    ...
    <form class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" placeholder="" class="input-text" name="title" id="title" value="">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" placeholder="" class="input-text" name="name" id="name" value="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系方式：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" placeholder="" class="input-text" name="phone" id="phone" value="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>摄像uid：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" placeholder="" class="input-text" name="uid" id="uid" value="">
            </div>
        </div>
        <div class="row cl">
...
//            success: "valid",
            submitHandler: function (form) {
                $('#form-admin-add').ajaxSubmit({
                    ...
                    url: "<?php echo U('Clinic/add_do');?>", // 需要提交的 url
                    data: {
                    },
